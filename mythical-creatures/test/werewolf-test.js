...
describe('Werewolf', function() {
  ...
  it('should start off not hungry', function() {
    // your code here
    var werewolf = new Werewolf('Michael J Fox');
  ...
  it('should not be hungry after changing back to human form', function() {
    // your code here
    var werewolf = new Werewolf('Roger');
    var victim = new Victim('Toby');
  ...
  it('should transform back to human form after eating', function() {
    // your code here
    var werewolf = new Werewolf('Voodoo');
  ...
  it('should not be able to eat a victim while in human form', function() {
    // your code here
    var werewolf = new Werewolf('Ole');
    var victim = new Victim('Susana')

    assert.equal(werewolf.human, true)
    assert.equal(werewolf.eat(victim), "I can't eat the victim becaues I'm a human")
    werewolf.transform();
    werewolf.eat(victim);
    // assert.equal(this.human, false);
    // werewolf.transform();
    // assert.equal(this.human, true);
    // assert.equal(werewolf.hungry, false)
