...
describe('Medusa', function() {
  ...
  it('should have a name', function() {
    ...
    var medusa = new Medusa('Voltron');
    var medusa1 = new Medusa('Dennise')

    assert.equal(medusa.name, 'Voltron');
    assert.equal(medusa1.name, 'Dennise');
  });
  ...
  it('should let the first victim go free when stoning the 4th', function() {
    ...
    assert.deepequal(medusa.statues.length, 3);
